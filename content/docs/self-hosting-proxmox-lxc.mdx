...
Follow the main [Self-Hosting Guide](./self-hosting) starting at **Step 1 — Create the directory structure**.
...
For database-level backups see the [Backup & Restore](./self-hosting#backup--restore) section in the main guide.
