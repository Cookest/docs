...
| Border radius — pill chips | 20px |
| Border radius — cards | 16px |
| Border radius — smaller containers | 12px |
| Border radius — list item thumbnails | 10px |
...
| State | Appearance |
|-------|------------|
| Active tab / day selector | 2px sage green underline — no filled background |
...
| Cooking mode step transition | Slide + fade | — |
