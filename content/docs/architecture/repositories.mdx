...
graph TD
    ...
    Docs -.->|"documents"| FoodAPI & AppAPI & UI & Web & ETL
```
...
| **ORM** | SeaORM 1.1 |
| **Services** | Food API + App API |
| **Database** | PostgreSQL 15+ |
| **Auth** | Argon2id + JWT (App API only) |
| **AI** | Ollama (App API chat + PDF vision) |
| **Payments** | Stripe webhooks |

**Purpose:** Core backend workspace with a standalone food catalog service and an authenticated application service.
